...
def main() -> int:
    ...
    emit("B4_STARTED", start_utc=start_utc, end_earliest_utc=end_utc, source_commit="af7e57ba1f0db88342e2efc192a3d3413c922ec6")
    ...
    payload = {
        ...
        "source_commit": "af7e57ba1f0db88342e2efc192a3d3413c922ec6",
        "cases": passed,
    }
    RESULT.write_text(json.dumps(payload, sort_keys=True, indent=2) + "\n", encoding="utf-8")
