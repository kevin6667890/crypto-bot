...
REFERENCE_COMPATIBILITY = {
 "MARKET_STATE":{"TIMELINE","TIMEFRAME"},"TIMEFRAME_STRUCTURE":{"TIMEFRAME"},
 "EXTENSION":{"TIMEFRAME"},"IMPULSE":{"TIMEFRAME","TIMELINE"},"PULLBACK":{"TIMEFRAME","TIMELINE"},
 "COMPRESSION":{"TIMEFRAME","TIMELINE"},"FLOW":{"ORDER_FLOW"},"OI":{"ORDER_FLOW"},
 "PRICE_OI_RELATION":{"ORDER_FLOW"},"LEVEL":{"LEVEL"},"TRIGGER":{"SCENARIO","LEVEL","TIMEFRAME"},
 "COVERAGE_METADATA":{"WARNING","ORDER_FLOW","TIMEFRAME","MACRO"},
 "CROSS_TIMEFRAME_SYNTHESIS":{"TIMEFRAME","TIMELINE"},
