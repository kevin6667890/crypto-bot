...
const en = {
  ...
  "nav.market": "Market Analysis", "nav.router": "Strategy Router V2", "nav.research": "Strategy Research", "nav.operations": "Operations",
...
const zh: Record<TranslationKey, string> = {
  ...
  "app.title":"Crypto-Bot · 量化决策工作台","app.workspace":"决策工作台","nav.market":"市场分析","nav.router":"策略路由 V2","nav.research":"策略研究","nav.operations":"系统运维",
