...
describe("Market + AI product closure", () => {
  it("places audited AI before charts and names the rule score honestly", () => {
    expect(app.indexOf("<WorkspaceAiBrief")).toBeLessThan(app.indexOf('<section className="chart-workspace">'));
