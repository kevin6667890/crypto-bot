...
export default function TrackDetailPage({ trackId }: { trackId: string }) {
  ...
  const definitionTitle = track.thesis_spec.version === "thesis-spec-v2"
    ...
    : track.thesis_spec.required_conditions.map(conditionExpression).join(" · ");
